...
<div class="container-fluid project-back">
	<div class="container portfolio-template">
				<div class="row no-gutters ">
						<div class="col-3 clicked" id="image" data-toggle="modal" data-target="#project_1">
					...
					<div class="col-3 " id="image" data-toggle="modal" data-target="#project_2">
					...
					<div class="col-3" id="image" data-toggle="modal" data-target="#project_3">
					...
					<div class="col-3" id="image" data-toggle="modal" data-target="#project_4">
					...
					<div class="col-3" id="image" data-toggle="modal" data-target="#project_5">
					...
					<div class="col-3" id="image" data-toggle="modal" data-target="#project_6">
					...
					<div class="col-3" id="image" data-toggle="modal" data-target="#project_7">
					...
					<div class="col-3" id="image" data-toggle="modal" data-target="#project_10">
						<img src="../img/project_img/project_10_front-min.jpg" alt="Жилой кирпичный дом" class="img-template">
						<p>
							Жилой кирпичный дом
						</p>
					</div>
					<div class="col-3" id="image" data-toggle="modal" data-target="#project_11">
					...
					<div class="col-3" id="image" data-toggle="modal" data-target="#project_14">
					...
					<div class="col-3" id="image" data-toggle="modal" data-target="#project_15">
					...
					<div class="col-3" id="image" data-toggle="modal" data-target="#project_16">
					...
					<div class="col-3" id="image" data-toggle="modal" data-target="#project_17">
					...
					<div class="col-3" id="image" data-toggle="modal" data-target="#project_18">
					...
					<div class="col-3" id="image" data-toggle="modal" data-target="#project_19">
					...
					<div class="col-3" id="image" data-toggle="modal" data-target="#project_20">
					...
					<div class="col-3" id="image" data-toggle="modal" data-target="#project_21">
